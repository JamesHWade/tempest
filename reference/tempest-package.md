...
evaluation helpers built on 'vitals'. Application-neutral contracts for
objectives, selected expert teams, scoped skills and capabilities,
generic workflow runs, versioned deliverables, typed evidence resources,
and typed artifacts let host applications customize generated outcomes
without embedding business-domain logic in the package.
