...
Accepted knowledge enters through
[`tempest_knowledge()`](https://jameshwade.github.io/tempest/reference/tempest_knowledge.md),
and new evidence still requires explicit Graft review and commit.
...
schema 5, Co-STORM snapshot and bundle schema 11, STORM bundle schema 8
...
Each run directory is an exact current schema-8 STORM product bundle
...
current schema-11 product. Expert, transcript, mind-map, StageRecord,
