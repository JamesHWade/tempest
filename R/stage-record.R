...
tempest_stage_fallback_section_writing <- function(chat, inputs, context) {
  prompt <- paste0(
    ...
    "- Return up to three observation items by copying the exact text of facts whose status is new; return none when no fact is new.\n",
...
tempest_stage_fallback_lead_section <- function(chat, inputs, context) {
  prompt <- paste0(
    ...
    "\n\nRules:\n",
    "- Each fact ends with its status against accepted knowledge: new, or already accepted.\n",
    "- Return up to three observations by copying the exact text of facts whose status is new; return none when no fact is new.\n",
