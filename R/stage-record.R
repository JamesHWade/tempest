...
tempest_stage_fallback_section_writing <- function(chat, inputs, context) {
  prompt <- paste0(
    ...
    "- Add at most one no-change item only by copying one claim that uses explicit unchanged, has not changed, did not change, or no material change language and does not also assert another change.\n",
