...
#' the section-10 deletion PR of the Tempest 0.2 migration train. They remain
#' in source only as deletion-owned baseline inventory, not as a compatibility
#' path.
#'
...
#'   `tempest_execution_events()` query
