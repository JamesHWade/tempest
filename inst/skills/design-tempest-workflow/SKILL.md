...
# Generic workflow design is unavailable

Tempest 0.2 has no application-neutral workflow-design API. Do not use the
retired generic kernel or its references. Use `use-tempest-research` with
